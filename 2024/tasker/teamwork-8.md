...
- dilarang menggunakan podman, docker, lxc dan jenis tool container serta emulasi.
...
- Aplikasi yang di install adalah InlisLite
- menggunakan apache+php-fpm untuk webserver
- Impelementasi CIS Server secara keseluruhan
- Aplikasi bisa diakses secara dalam jaringan local
- Firewalld telah terkonfigurasi dengan tepat
...
- Dilarang menggunakan package base-devel, jika di butuhkan aplikasi pendukung install secara mandiri di luar package meta base-devel
- meggunakan kernel linux-hardened
- dilarang menggunakan podman, docker, lxc dan jenis tool container serta aplikasi emulasi dan virtualisasi.
- setiap orang memahami setiap alur pekerjaan, 
- diharuskan menggunakan project pada github project,
- pemahaman terhadap langkah yang diguanakan, tidak hanya sebatas eksekusi
...
- Aplikasi yang di install adalah Slims
- menggunakan nginx+php-fpm untuk webserver
- Impelementasi CIS Server secara keseluruhan
- Aplikasi bisa diakses secara dalam jaringan local
- Firewalld telah terkonfigurasi dengan tepat
- Disable module kernel yang tidak diperlukan
...
- presentator yang gagal akan diberikan kesempatan mengulang sebanyak 3 kali 


### pengumpulan
- presentator mengumpulkan penugasan di dalam repo penguasan masing masing pada hari Rabu, 3 Juni 2026 jam 07.30 AM  
...
2. project github, minta kepada administrator kelas untuk membuat project baru dengan model iteratif.
3. Rekaman audio dari proses yang dikerjakan.


## Audience
1. Untuk setiap anggota kelas, mulai minggu ini sesi kelas akan diberikan 1 minggu setelah tugas presentator di release. Tepatnya tanggal 5 juni 2026.
2. Mulai dari sesi ini penugasan audience diberikan didalam direktori practice. 
3. Waktu pengerjaan penugasan 3x24 jam, setelah penugasan audience di release.
...
5.  waktu pengumpulan audience secara serentak akan ditutup pada hari Senin Tanggal 8 Juni jam 23.59 WIB.  
